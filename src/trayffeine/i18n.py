...
CATALOGS: dict[LocaleCode, Catalog] = {
    ...
    "pt-BR": {
        "app.name": "Trayffeine",
        "tray.tooltip.active_infinite": "Trayffeine: ativo ha {elapsed} | infinito",
        "tray.tooltip.active_remaining": "Trayffeine: ativo ha {elapsed} | faltam {remaining}",
        ...
        "tray.summary.timed": "Ativo ate {time}",
